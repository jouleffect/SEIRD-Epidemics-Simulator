...
def clear():
	...
	img3 = PhotoImage(file='plots/empty.png')
...
title = Label(right_frame, text="SEIRD Simulator", bg='skyblue')
...
Spinbox(tool_bar1, textvariable = num_nodi, from_= 0, increment=10, to=100000).grid(row=1, column=1, padx=5, pady=5)

Label(tool_bar1, text="Link probability").grid(row=2, column=0, padx=5, pady=3, ipadx=10)
Spinbox(tool_bar1, textvariable = p_link, from_= 0.0, increment=0.001, to=1.0, format="%.4f").grid(row=2, column=1, padx=5, pady=5)
...
Label(tool_bar2, text="Mortality rate").grid(row=8, column=0, padx=5, pady=3, ipadx=10)
